...
friends, completed my work, and handled project management tasks as well. {{% wikipedia article="Python (programming language)" %}} is catching up well—it's really a cool language. Once I become sufficiently
...
[{{% wikipedia article="Paul Graham (programmer)" text="Paul Graham" %}}'s article on power](http://www.paulgraham.com/power.html)
...
I read the article last week. Though it was thought provoking, it did not much disturb me as not to dive deeper into python. I dont know, sometimes I stumble upon few limitations but they are more due to lack of knowledge than anything else. Python I have found to be easy to write a program in. esr has some of his thoughts on python [here](http://www.linuxjournal.com/article/3882).
